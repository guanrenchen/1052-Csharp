...
namespace WP_Final.AccessDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [Id] = @Id, [username] = @username, [Password] = @Password WHERE (([Id] = @Original_Id) AND ([username] = @Original_username) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)));
SELECT Id, username, Password FROM Users WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WP_Final.Properties.Settings.Default.AccessConnectionString;
        }
        ...
        public virtual int Fill(AccessDataSet.UsersDataTable dataTable) {
        ...
        public virtual AccessDataSet.UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AccessDataSet.UsersDataTable dataTable = new AccessDataSet.UsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AccessDataSet.UsersDataTable dataTable) {
